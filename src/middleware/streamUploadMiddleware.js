// src/middleware/streamUploadMiddleware.js
...
const storage = multer.diskStorage({
  destination: function (req, file, cb) {
    ...
    const uploadPath = path.join(__dirname, '../../public/images/streams');
  ...
  filename: function (req, file, cb) {
    ...
    // fieldname burada 'coverImage' olacak
    cb(null, 'stream-' + uniqueSuffix + fileExtension);
  }
});
...
const uploadStreamCover = multer({
  storage: storage,
  limits: {
...
module.exports = uploadStreamCover;